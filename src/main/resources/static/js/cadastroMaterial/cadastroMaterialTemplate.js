...
const CadastroMaterialTemplate = {
		...
		<div class="modal-dialog modal-lg ">
	        <div class="modal-content">
	            ...
	            <div class="modal-footer">
	            	<button type="button" class="btn btn-success" onClick="CadastroMaterialController.salvar()" >Salvar</button>
	...
	itemLinha(data){
		return `
			<tr>
				...
				<td>
					<span onclick="CadastroMaterialController.editar(${data.id});" class="glyphicon glyphicon-pencil"></span>
					<span onclick="CadastroMaterialController.deletar(${data.id});" class="glyphicon glyphicon-trash"></span>
				</td>
			</tr>
		`;
