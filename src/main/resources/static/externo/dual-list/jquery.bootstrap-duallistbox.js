(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: 'Mostrar todos {0}',                                                        // text when all options are visible / false for no info text
      ...
      btnClass: 'form-control btn-primary',                                                  // sets the button style class for all the buttons
