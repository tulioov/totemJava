...
<head>
	...
	<title>Cadastro de Status de Monitoracao</title>
</head>
<body>
	...
	<div class="container">
		<div class="row">
			<button type="submit" onclick="CadastroStatusMonitoracaoController.addUser();" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
				Add Menu Pausa
			</button>
	...
	<script src="../js/cadastroStatusMonitoracao/cadastroStatusMonitoracaoTemplate.js"></script>
	<script src="../js/cadastroStatusMonitoracao/cadastroStatusMonitoracaoController.js"></script>
</body>
</html>
