...
<body>
	...
	<div class="container">
		<div class="row">
			<button type="submit" onclick="CadastroMaterialController.addUser();" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
				Add Material
			</button>
		...
		<div class="row">
			<table id="tableMaterial" class="display">
				<thead>
			    <tr>
			        <th>ID</th>
			        <th>Nome</th>
	...
	<script src="../js/cadastroMaterial/cadastroMaterialTemplate.js"></script>
	<script src="../js/cadastroMaterial/cadastroMaterialController.js"></script>
</body>
</html>
