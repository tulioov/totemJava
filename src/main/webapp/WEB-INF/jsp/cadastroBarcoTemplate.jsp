...
<head>
	...
	<title>Cadastro de Barco Template</title>
</head>
<body>
	...
	<div class="container">
		<div class="row">
			<button type="submit" onclick="CadastroBarcoTemplateController.addUser();" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
				Add Barco template
			</button>
		...
		<div class="row">
			<table id="tableBarcoTemplate" class="display">
				<thead>
			    <tr>
			        <th>ID</th>
			        <th>Nome</th>
	...
	<script src="../js/cadastroBarcoTemplate/cadastroBarcoTemplateTemplate.js"></script>
	<script src="../js/cadastroBarcoTemplate/cadastroBarcoTemplateController.js"></script>
</body>
</html>
